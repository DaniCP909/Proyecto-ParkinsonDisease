...
def main():
    ...
    parser.add_argument('--epochs', type=int, default=150, metavar='N', help='number of epochs to train (default = 14)')
    ...
    global_max_w = pahaw_loader.global_max_resized_w
    global_max_h = pahaw_loader.global_max_h

#Train and validate definition
...
#Train and validate patients
    ...
    print(f"Isolated patient: {args.isolated}")
    print("========================================")

#Training (generating pytorch datasets)
    t0_train = time()

    model, train_history, validate_history = run_pipeline(train, val, args, device, train_kwargs, validate_kwargs, task_nums=task_numbers, global_h=global_max_h, global_w=global_max_w)
