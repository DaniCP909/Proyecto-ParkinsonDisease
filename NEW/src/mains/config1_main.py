...
def main():
    ...
    parser.add_argument('--group', type=int, default=0, metavar='N', help='selected group (0-4)(default = 0)')
    parser.add_argument(
        "--tasks",
        type=int,
        nargs="+",
    ...
    test_list = [41, 32, 72, 91, 84, 85, 61, 53, 7, 2, 6, 24, 18]
    train_list = [31, 60, 71, 82, 28, 89, 95, 76, 97, 27, 90, 30, 96, 70, 49, 62, 40, 57, 94, 52, 39, 26, 87, 29, 66, 51, 67, 73, 69, 83, 92, 48, 74, 10, 17, 75, 55, 3, 98, 78, 5, 80, 13, 19, 43, 16, 15, 8, 1, 4, 9, 25, 20, 54, 33, 36, 14, 22, 34, 23, 44, 77]
...
#
    model, accuracy_history, train_losses, validate_losses = run_pipeline(train, val, args, device, train_kwargs, validate_kwargs, task_nums=task_numbers, writer=writer) 
#
