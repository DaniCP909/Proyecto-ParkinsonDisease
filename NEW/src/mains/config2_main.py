...
def main():
    ...
    test_list = [17, 7, 4, 18, 67, 49, 30, 69, 97, 85, 82, 98, 48]
    train_list = [19, 9, 55, 53, 70, 52, 87, 84, 66, 95, 91, 27, 76, 28, 39, 57, 90, 83, 71, 31, 96, 61, 40, 26, 29, 41, 73, 89, 32, 94, 60, 51, 92, 62, 72, 43, 24, 75, 74, 2, 36, 3, 10, 16, 54, 44, 25, 6, 80, 22, 13, 1, 5, 14, 34, 8, 78, 20, 15, 77, 23, 33]
...
#
    model, accuracy_history, train_losses, validate_losses = run_pipeline(train, val, args, device, train_kwargs, validate_kwargs, task_nums=task_numbers) 
#
